  ...
  return (
    <div className='box' style={{ backgroundColor: `${color}` }}>
      ...
      <div className="card-content">
        <TodoList flag={flag} todosDoFirst={todosDoFirst} />
        <TodoList flag={flag} todosSchedule={todosSchedule} />
        <TodoList flag={flag} todosDelegate={todosDelegate} />
        <TodoList flag={flag} todosDontDo={todosDontDo} />
        <Draggable >
          {(provided, snapshot) => (
